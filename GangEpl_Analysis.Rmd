...
```{r load packages, echo = FALSE, warning = FALSE, cache=TRUE, results='hide'}
...
```{r import data, echo=FALSE, cache=TRUE, warning = FALSE}
...
```{r histograms of selected variables, cache=TRUE, warning = FALSE}
...
```{r Computing Scale Score, cache=TRUE, echo=FALSE, warning = FALSE}
GangEpl <- GangEpl %>% 
...
```{r EmployHrs ~ Date, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r EmployWg ~ Date, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r spaghetti plot, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r Individual Trajectories, cache=TRUE, echo=FALSE, warning = FALSE}
GangEpl %>% 
  ggplot(aes(x = Date)) + 
...
```{r random Intercep Model of EmployHrs, cache=TRUE, echo=FALSE, warning = FALSE, results='hide'}
ran_int_EmployHrs <- brm(EmployHrs ~ (1 | ID), data = GangEpl, 
               seed = 2152)
```

```{r results_EmployHrs, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r random Intercep Model of EmployWg, cache=TRUE, echo=FALSE, warning = FALSE, results='hide'}
ran_int_EmployWg <- brm(EmployWg ~ (1 | ID), data = GangEpl, 
               seed = 2152)
```

```{r result_EmployWg, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r random Intercep Model of GangInv, cache=TRUE, echo=FALSE, warning = FALSE, results='hide'}
ran_int_GangInv <- brm(GangInv ~ (1 | ID), data = GangEpl, 
               seed = 2152)
```

```{r result_GangInv, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r random Intercep Model of GangMem, cache=TRUE, echo=FALSE, warning = FALSE, results='hide'}
ran_int_GangMem <- brm(GangMem ~ (1 | ID), data = GangEpl, 
               seed = 2152)
```

```{r result_GangMem, cache=TRUE, echo=FALSE, warning = FALSE}
...
```{r trend checking, echo=FALSE, cache=TRUE, warning = FALSE, results='hide'}
m_Trend <- brm(EmployHrs ~ Date + (Date | ID), data = GangEpl, 
          seed = 2313, 
          control = list(adapt_delta = .90))
```

```{r result_m_Trend, echo=FALSE, cache=TRUE, warning = FALSE}
summary(m_Trend)
```
...
```{r centering variables, cache=TRUE, echo=FALSE, warning = FALSE, results='hide'}
GangEpl <- GangEpl %>% 
  group_by(ID) %>% 
...
```{r between-within effects, echo=FALSE, cache=TRUE, warning = FALSE, results='hide'}
...
```{r results_m_EmployHrs, cache=TRUE, echo=FALSE, warning = FALSE}
summary(m_EmployHrs)
```
