...
- Here are some plots of within-person conditional effects of covariates on Gang Involvement. For both gaussian and binomial models, the plots indicate that days spent with gang for each participant became averagely decreasing as the employment hours increase.
...
1. It looks like Employment Hours does have a within-person level (centered person-mean significant effects on Gang Involvement, Gang Membership, and Gang Activity. The general trends for three paired relationship are both slightly decreasing.
...
2. The lag predictor of Employment Hours wasn't found significantly predicting three DVs. 
